			...
			<fieldset ${entity.operacao eq 'EXIBICAO' ? 'disabled' : ''}>
    			...
    			<div class="form-group">
					...
					<div class="form-group">
						...
						<label class="radio-inline">
							<input id="input-tipo" class="list-group" type="radio" name="entity.tipo" value="CARTAO CREDITO" checked="${entity.tipo}"> Cartão de Crédito 
						</label>
						<label class="radio-inline">		
							<input id="input-tipo" class="list-group" type="radio" name="entity.tipo" value="CARTAO DEBITO" checked="${entity.tipo}"> Cartão de Débito
						</label>
    				</div>
			</fieldset>
